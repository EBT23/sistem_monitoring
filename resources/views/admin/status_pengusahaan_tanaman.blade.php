                           ...
                           <tbody>
                              ...
                              <tr>
                                 ...
                                 <td class="d-flex">
                                    ...
                                    <span>
                                       <button type="button" class="btn btn-primary mt-2" data-bs-toggle="modal" data-bs-target="#exampleModal{{ $spt->id }}">
                                        Update
                                      </button>
                                    </span>
                                  ...
                                  <div class="modal fade" id="exampleModal{{ $spt->id }}" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
                                    <div class="modal-dialog modal-lg">
                                      <div class="modal-content">
                                        ...
                                        <div class="modal-body">
                                          <form action="{{ route('update.status_pengusahaan',['id'=>$spt->id]) }}" method="POST">
                                             @csrf
                                              <div class="form-group">
                                                <h4 class="card-title">Form Tambah Data</h4>
                                                  <label class="form-label" for="status_pengusahaan_tanaman">Masukkan Nama Status Pengusahaan tanaman</label>
                                                  <input name="status_pengusahaan_tanaman" class="form-control" id="status_pengusahaan_tanaman" value="{{ $spt->status_pengusahaan_tanaman }}">
                                              </div>
                                                 <div class="checkbox mb-3">
                                              </div>
