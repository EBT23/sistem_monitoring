                           ...
                           <tbody>
                              ...
                              <tr>
                                 ...
                                 <td class="d-flex">
                                    ...
                                    <span>
                                       <button type="button" class="btn btn-primary mt-2" data-bs-toggle="modal" data-bs-target="#exampleModal{{ $kp->id }}">
                                        Update
                                      </button>
                                    </span>
                                  ...
                                  <div class="modal fade" id="exampleModal{{ $kp->id }}" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
                                    <div class="modal-dialog modal-lg">
                                      <div class="modal-content">
                                        ...
                                        <div class="modal-body">
                                          <form action="{{ route('update.kabupaten',['id'=>$kp->id]) }}" method="POST">
                                             @csrf
                                              <div class="form-group">
                                                <h4 class="card-title">Form Tambah Data</h4>
                                                   <label class="form-label text-black" for="id_provinsi">Pilih Provinsi</label>
                                                   <select name="id_provinsi" id="id_provinsi" class="form-control">
                                                      <option value="" selected>pilih provinsi</option>
                                                      @foreach ($provinsi as $p )
                                                      <option @if($p->id_prov == $kp->id_provinsi) selected @endif value="{{ $p->id_prov }}" >{{ $p->nama_provinsi }}</option>
                                                      @endforeach
                                                   </select>
                                                      
                                                   <label class="form-label mt-3 text-black" for="nama_kabupaten">Masukkan Nama kabupaten</label>
                                                   <input name="nama_kabupaten" class="form-control" id="nama_kabupaten" value="{{ $kp->nama_kabupaten }}">
                                              </div>
                                                 <div class="checkbox mb-3">
                                              </div>
