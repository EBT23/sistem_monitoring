                           ...
                           <tbody>
                              ...
                              <tr>
                                 ...
                                 <td class="d-flex">
                                    ...
                                    <span>
                                       <button type="button" class="btn btn-primary mt-2" data-bs-toggle="modal" data-bs-target="#exampleModal{{ $kc->id }}">
                                        Update
                                      </button>
                                    </span>
                                  ...
                                  <div class="modal fade" id="exampleModal{{ $kc->id }}" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
                                    <div class="modal-dialog modal-lg">
                                      <div class="modal-content">
                                        ...
                                        <div class="modal-body">
                                          <form action="{{ route('update.kecamatan',['id'=>$kc->id]) }}" method="POST">
                                             @csrf
                                              <div class="form-group">
                                                <h4 class="card-title">Form Tambah Data</h4>
                                                   <label class="form-label text-black" for="id_kabupaten">Pilih kabupaten</label>
                                                   <select name="id_kabupaten" id="id_kabupaten" class="form-control">
                                                      <option value="" selected>pilih kabupaten</option>
                                                      @foreach ($kabupaten as $k )
                                                      <option @if($k->id == $kc->id_kab) selected @endif value="{{ $k->id }}" >{{ $k->nama_kabupaten }}</option>
                                                      @endforeach
                                                   </select>
                                                      
                                                   <label class="form-label mt-3 text-black" for="nama_kecamatan">Masukkan Nama kabupaten</label>
                                                   <input name="nama_kecamatan" class="form-control" id="nama_kecamatan" value="{{ $kc->nama_kecamatan }}">
                                              </div>
                                                 <div class="checkbox mb-3">
                                              </div>
