                           ...
                           <tbody>
                              ...
                              <tr>
                                 ...
                                 <td class="d-flex">
                                    ...
                                    <span>
                                       <button type="button" class="btn btn-primary mt-2" data-bs-toggle="modal" data-bs-target="#exampleModal{{ $s->id }}">
                                        Update
                                      </button>
                                    </span>
                                          ...
                                          <form action="{{ route('update.semester',['id'=>$s->id]) }}" method="POST">
                                             @csrf
                                              <div class="form-group">
                                                <h4 class="card-title">Form Tambah Data</h4>
                                                  <label class="form-label" for="nama_semester">Masukkan Nama semester</label>
                                                  <input name="nama_semester" class="form-control" id="nama_semester" value="{{ $s->semester }}">
                                              </div>
                                                 <div class="checkbox mb-3">
                                              </div>
