                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td class="d-flex">
                                            ...
                                            <span>
                                                <button type="button" class="btn btn-primary mt-2" data-bs-toggle="modal" data-bs-target="#exampleModal{{ $r->id }}">
                                                    Update
                                                </button>
                                            </span>
                                                ...
                                                <div class="modal-dialog modal-lg">
                                                    <div class="modal-content">
                                                        <div class="modal-header">
                                                            <h5 class="modal-title" id="exampleModalLabel">Update Data role</h5>
                                                            <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                                                        </div>
                                                        <div class="modal-body">
                                                            <form action="{{ route('update.role',['id'=>$r->id]) }}" method="POST">
                                                                @csrf
                                                                <div class="form-group">
                                                                    <h4 class="card-title">Form Tambah Data</h4>
                                                                    <label class="form-label" for="role">Masukkan Nama role</label>
                                                                    <input name="role" class="form-control" id="role" value="{{ $r->role }}">
                                                                </div>
