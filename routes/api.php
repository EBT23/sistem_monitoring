...
Route::middleware(['auth:sanctum'])->group(function () {
    ...
    Route::post('/jumlah_produksi_by_komoditi', [ApiAllController::class, 'jumlah_produksi_by_komoditi']); 
    Route::post('/luas_lahan_by_komoditi', [ApiAllController::class, 'luas_lahan_by_komoditi']); 
});
